...
@section('content')
    ...
    <section class="content sec-mar">
        <div class="container">
            <h1>Privacy policy last updated on – 12 December 2023</h1>
            <hr>
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="content-text">
                        ...
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                            ...
                            libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod
                            maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.
                            Temporibus autem quibusdam et aut officiis debitis aut rerum.</p>
                        ...
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                            ...
                            libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod
                            maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.
                            Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe.</p>
                ...
                <div class="col-lg-4 col-12">
                    <div class="content-text-block bg-color-black">
                        <h2>Table of Contents</h2>
                        <ul>
                            <li>Who we are?</li>
                            <li>What we do?</li>
                            <li>Data you provide us when you create an account</li>
                            <li>Information we automatically collect</li>
                            <li>Whenever you leave a reply</li>
                            <li>Cookies that we use</li>
                            <li>Third party data collection</li>
                            <li>How safe is my information?</li>
                        </ul>
                    </div>
                </div>
            </div>
